    ...
    Group(
        ...
        value_args=[
            (
                ...
                'если вы совершили атаку действием в ближнем бою [U]'
            ),
        ],
    ),
    Group(
        ...
        value_args=[
            (
                ...
                'этот эффект нельзя убрать ничем, пока вы используете оружие [U]'
            ),
        ],
    ),
    Group(
        ...
        type_args=['Вампиризм'],
        value_args=[
            'если ты попадаешь по существу атакой оружием в радиусе 10фт, то восстанавливаешь 2 хит поинта [U]',
        ],
    ),
    Group(
        tags=ItemTags(weapon=True),
        ...
        value_args=[
            (
                ...
                'сл 8 + бонус мастерства + мод силы или упадет ничком [U]'
            ),
        ],
    ),
    Group(
        ...
        value_args=[
            'раз в день вы можете одним действием наложить два заклинания [U]',
        ],
    ),
]
